...
class PageDetailDocter : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        enableEdgeToEdge()
        setContentView(R.layout.activity_page_detail_docter)
        ...
        txtback.setOnClickListener(){
            val intent = Intent(this@PageDetailDocter,PageDisplayList::class.java)
